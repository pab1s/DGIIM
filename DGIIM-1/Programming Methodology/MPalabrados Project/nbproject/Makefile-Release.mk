...
${OBJECTDIR}/src/bag_nomain.o: ${OBJECTDIR}/src/bag.o src/bag.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/bag_nomain.o src/bag.cpp;\
	else  \
...
${OBJECTDIR}/src/move_nomain.o: ${OBJECTDIR}/src/move.o src/move.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/move_nomain.o src/move.cpp;\
	else  \
...
${OBJECTDIR}/src/movelist_nomain.o: ${OBJECTDIR}/src/movelist.o src/movelist.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/movelist_nomain.o src/movelist.cpp;\
	else  \
...
${OBJECTDIR}/src/player_nomain.o: ${OBJECTDIR}/src/player.o src/player.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/player_nomain.o src/player.cpp;\
	else  \
...
${OBJECTDIR}/src/tiles_nomain.o: ${OBJECTDIR}/src/tiles.o src/tiles.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tiles_nomain.o src/tiles.cpp;\
	else  \
...
${OBJECTDIR}/src/window_nomain.o: ${OBJECTDIR}/src/window.o src/window.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/window_nomain.o src/window.cpp;\
	else  \
