 ...
 */
 ...
 // cambiarNombre() tambien usa el metodo buscarNombre()
 g.cambiarNombre("111111111", "Fulanito de Tal");
 g.cambiarTlf("Fulanito de Tal", "911111119");
 
 cout << "Esta es la guia modificada: " << endl;
 cout << g << endl;
 cout << "Devuelve 1 si es vacia, si no, devuelve 0: " << g.esVacia() << endl;
}
